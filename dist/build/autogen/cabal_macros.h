...
/* package functional-parsing-0.1.0.0 */
#define VERSION_functional_parsing "0.1.0.0"
#define MIN_VERSION_functional_parsing(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "functional-parsing-0.1.0.0-DymQ2eXu6gi5m5xdhSJYLr"

#define CURRENT_PACKAGE_KEY "functional-parsing-0.1.0.0-DymQ2eXu6gi5m5xdhSJYLr"
